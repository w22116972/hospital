...
#import "tabBarCtrlColor.h"
#import "KxMenu.h"

@interface tabBarCtrlColor ()

@end

@implementation tabBarCtrlColor{
...
- (void)showMenu:(UIButton *)sender
{
    ...
    @[
      ...
      [KxMenuItem menuItem:@"笑臉：等候人數少"
                     image:nil
                    target:self
                    action:NULL],
      
      [KxMenuItem menuItem:@"普臉：等候人數中"
                     image:nil
                    target:self
                    action:NULL],
      
      [KxMenuItem menuItem:@"哭臉：等候人數高"
                     image:nil
                    target:self
                    action:NULL],
